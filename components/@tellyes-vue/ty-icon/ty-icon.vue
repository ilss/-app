...
<script>
	 ...
	 * @property {String} prefix-class 自定义字体图标库前缀 - 默认ty-icon  
	 ...
	 * @example <ty-icon type="bell" size="30" color="#654321"></ty-icon>  
	 */
	export default {
		name: 'ty-icon',
...
<style>
	...
	.ty-icon-add-circle::before {
		content: "\e901";
	}

	.ty-icon-subtract::before {
		content: "\e962";
	}

	.ty-icon-subtract-circle::before {
		content: "\e961";
	}

	.ty-icon-align-center::before {
		content: "\e902";
	}

	.ty-icon-align-left::before {
		content: "\e903";
	}

	.ty-icon-align-right::before {
		content: "\e904";
	}
	...
	.ty-icon-close-circle::before {
		content: "\e916";
	}

	.ty-icon-close::before {
		content: "\e917";
	}
	...
	.ty-icon-equalizer::before {
		content: "\e91c";
	}

	.ty-icon-external-link::before {
		content: "\e91d";
	}
	...
	.ty-icon-file-audio::before {
		content: "\e91f";
	}

	.ty-icon-file-code::before {
		content: "\e920";
	}

	.ty-icon-file-generic::before {
		content: "\e921";
	}

	.ty-icon-file-jpg::before {
		content: "\e923";
	}

	.ty-icon-file-new::before {
		content: "\e924";
	}

	.ty-icon-file-png::before {
		content: "\e925";
	}

	.ty-icon-file-svg::before {
		content: "\e926";
	}

	.ty-icon-file-video::before {
		content: "\e927";
	}
	...
	.ty-icon-iphone-x::before {
		content: "\e92f";
	}

	.ty-icon-iphone::before {
		content: "\e930";
	}

	.ty-icon-lightning-bolt::before {
		content: "\e931";
	}
	...
	.ty-icon-numbered-list::before {
		content: "\e93b";
	}

	.ty-icon-pause::before {
		content: "\e93c";
	}
	...
	.ty-icon-reload::before {
		content: "\e941";
	}

	.ty-icon-repety-play::before {
		content: "\e942";
	}
	...
	.ty-icon-shuffle-play::before {
		content: "\e94a";
	}

	.ty-icon-sketch::before {
		content: "\e94b";
	}

	.ty-icon-sound::before {
		content: "\e94c";
	}
	...
	.ty-icon-text-italic::before {
		content: "\e952";
	}

	.ty-icon-text-strikethrough::before {
		content: "\e953";
	}

	.ty-icon-text-underline::before {
		content: "\e954";
	}
	...
	.ty-icon-volume-minus::before {
		content: "\e959";
	}

	.ty-icon-volume-off::before {
		content: "\e95a";
	}

	.ty-icon-volume-plus::before {
		content: "\e95b";
	}

	.ty-icon-analytics::before {
		content: "\e95c";
	}

	.ty-icon-star-2::before {
		content: "\e95d";
	}

	.ty-icon-check::before {
		content: "\e95e";
	}

	.ty-icon-heart-2::before {
		content: "\e95f";
	}

	.ty-icon-loading::before {
		content: "\e967";
	}

	.ty-icon-loading-2::before {
		content: "\e966";
	}

	.ty-icon-loading-3::before {
		content: "\e963";
	}

	.ty-icon-alert-circle::before {
		content: "\e964";
	}
</style>
