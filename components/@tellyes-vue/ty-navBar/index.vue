<template>
	<cover-view style="z-index: 99999999999;">
		<view
			class="header"
...
.header {
	...
	&.colorWhite {
		.left_info {
			...
			.back {
				background-image: url('/static/ty-navBar/icon_back_white.png');
			}
			text {
				background-color: rgba(255, 255, 255, 0.3);
			}
			.home {
				background-image: url('/static/ty-navBar/icon_home_white.png');
			}
		}
	}
	.left_box {
	...
	.left_info {
		...
		.back {
			background-image: url('/static/ty-navBar/icon_back_black.png');
		...
		.home {
			background-image: url('/static/ty-navBar/icon_home_black.png');
			background-position: center center;
			background-repeat: no-repeat;
			background-size: auto 55%;
			width: $height;
