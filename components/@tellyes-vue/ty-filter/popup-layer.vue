  ...
  computed: {
    _translate() {
      if (this.isTransNav) {
        const transformObj = {
          ...
          bottom: `transform:translateY(calc(${this.translateValue}% + ${
            this.navHeight
          }px))`,
    ...
    _location() {
      ...
      positionValue = {
        ...
        bottom: 'top:' + this.tabHeight + 'upx;width:100%;',
      ...
      positionValue = {
        top: 'bottom:0px;width:100%;',
        bottom: 'top:' + (this.tabHeight + 80) + 'upx;width:100%;',
        left: 'right:0px;height:100%;',
        right: 'left:0px;height:100%;'
      }
      // #endif
